...
- Flood(fatal=1.87%, serious=23.51%) and wet(fatal=0.88%, serious=17.11%) had the highest proportion of fatal and serious accidents. The association between road conditions with reference to severity was staistically significant (chi_statistic = 78.14, p < 0.001, cramers-v = 0.00687). Based on the cramers-v, the overall practical impact of road conditions on severity is negligible. Wet and frost show statistically significant associations with more severe outcomes.
...
- Clear and windy(fatal=1.3%, serious=20%), rain and windy(fatal=1.3%, serious=18%), fog(fatal=1.2%, serious=18%) had the highest rates for severe injuries.
- Weather conditions and accident severity was statistically related (chi_statistic = 480.79, p < 0.001, cramers-v = 0.0170) but the practical implications are negligible based on the Cramer's V.
...
- Dual carriageway(fatal=2.11%, serious=19.10%), Slip road(fatal=0.83%, serious=18.09%)	and Single carriageway(fatal=0.77%, serious=17.25%) had the highest rate of fatal accidents. The association between road types and accident severity was statistically significant (chi_statistic = 2884.07, p = 0.0, cramers_v = 0.0417). Despite strong statistical significance, road type has negligible impact on variance in severity.
...
- Darkness lights lit (fatal=0.75%,	serious=17.58%) and Darkness no lights (fatal=3.35%, serious=22.81%) had the highest rate of severe accident injuries.
Light conditions and the severity of accidents have a statistically significant but weak association (chi_statistic = 2923.25, p = 0.0, cramers-v = 0.0420).
-----------------------------------------------------------------------------------------
### Time  
...
- The association between severity between the age group (chi_statistic = 7371.50, p = 0.0, cramers-v = 0.066) was statistically significant with a weak magnitude.
- The distribution of severity(fatal and serious) among age groups were the following 66 to 75(fatal(%)=3.84, serious(%)=26.18), 36 to 45(fatal(%)=0.78, serious(%)=17.26), 46 to 55(fatal(%)=1.24, serious(%)=20.48), 56 to 65(fatal(%)=2.06, serious(%)=23.46). Fatal and serious injuries increase with age (after 36 years).
...
- Males experienced more serious(Males=17.08%, Females=16.01%) and fatal(Males=0.84%, Females=0.71%) injuries than females. However, females experience more slight injuries than males.
- An assumption for the chi-square test were not met. This was because the percentage of expected values less than 5 (33.33%) exceeded 20%. The hypothesis was therefore not tested on these features.
...
- Bad weather does not result in increased casualties per accident.
- Dual carriageways are extremely dangerous for fatal and serious bicycle accidents.
- Windy conditions and fog may increase injury severity.
